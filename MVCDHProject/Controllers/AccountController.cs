...
namespace MVCDHProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void SendMail(IdentityUser identityUser, string requestLink, string subject)
        {
            ...
            {
                mailBody.Append("Click on the below button to confirm your email:");
                msg = "Confirm Your Email";
            }
            else if (subject == "Change Password Link")
            {
                mailBody.Append("Click on the below button to reset your password:");
                msg = "Reset Your Password";
            }
            mailBody.Append("<br />");
            mailBody.Append("<a href='"+requestLink);
            mailBody.Append("'>"+msg+"</a>");
            ...
            MailboxAddress fromAddress = new MailboxAddress("Customer Support", "rahul.whiztekcorp@gmail.com");
            ...
            smtpClient.Authenticate("rahul.whiztekcorp@gmail.com", "jqptslibkwnwdkkk");
            smtpClient.Send(mailMessage);
        }

        #endregion
        #region Confirmation Link 
        ...
        #endregion
        #region External Logins (Google and Facebook)
